...
export class Tab3Page {
  ...
  async getData() {
    ...
    try{
      const res = await axios.post('http://localhost/data_api/get_data_mahasiswaId.php', fd);
  ...
  try{
    const res = await axios.post('http://localhost/data_api/update_data_mahasiswa.php', fd);
