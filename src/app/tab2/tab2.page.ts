...
export class Tab2Page {
  ...
  async getData() {
    try {
      const res = await axios.get('http://localhost/data_api/get_data_mahasiswa.php');
  ...
  async deleteData(id) {
    ...
    fd.append('id',id);
    try{
      const res = await axios.post('http://localhost/data_api/delete_data_mahasiswa.php', fd);
